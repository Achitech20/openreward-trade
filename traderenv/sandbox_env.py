...
class SandboxEnv(Environment):
    ...
    async def setup(self) -> None:
        ...
        download_cmd = (
            ...
            f'-o /home/ubuntu/data/dataset.csv'
        )
    ...
    async def get_prompt(self) -> List[TextBlock]:
        ...
        full_prompt = f"""You are participating in task {self.task_id}. Please explore the file system. Check /home/ubuntu/data/."""

        # potentially each task for each prompt.... Key by tasks.
